...
if vim.g.neodarker_italic_keywords then
    italic_keywords = true
end

if vim.g.neodarker_italic_functions then
    italic_functions = true
end

if vim.g.neodarker_italic_comments then
    italic_comments = true
end

if vim.g.neodarker_italic_loops then
    italic_loops = true
end

if vim.g.neodarker_italic_conditionals then
...
theme.set_highlights = function()
    ...
    hl(0, "Folded", { fg = "NONE", bg = c.line })  -- link CursorLine
    ...
    hl(0, "Conditional", { fg = c.purple, bg = "NONE", italic = italic_conditionals })
    hl(0, "Repeat", { fg = c.purple, bg = "NONE", italic = italic_loops })
    ...
    if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
        ...
        hl(0, "@storage.class", { link = "StorageClass" })
        ...
        hl(0, "@annotation", { fg = c.blue, bg = "NONE" })
        ...
        hl(0, "@text.math", { fg = c.yellow, bg = "NONE" })
        hl(0, "@text.literal", { fg = c.orange, bg = "NONE" })
    else
        -- Treesitter
        hl(0, "TSComment", { link = "Comment" })
        hl(0, "TSVariable", { link = "Variable" })
        hl(0, "TSVariableBuiltin", { fg = c.yellow })
    ...
    hl(0, "markdownUrl", { fg = c.cyan, bg = "NONE" })
    ...
    -- Illuminate
    hl(0, "IlluminatedWordText", { fg = "NONE", bg = c.ui2_blue })
    hl(0, "IlluminatedWordRead", { fg = "NONE", bg = c.ui2_blue })
    hl(0, "IlluminatedWordWrite", { fg = "NONE", bg = c.ui2_blue })
